function updatePrompt(){const s=document.getElementById("lang-select"),e=s.value,t=document.getElementById("prompt-box"),n=t.getAttribute("data-base");if(!e){t.textContent=n;return}let o=`👉 STRICT LANGUAGE RULE:
